...
// inherit size, length(); isEmpty
  ...
  public DList() {
    ...
    System.out.println("DList.head= "+this.head);
    head.prev=head;
    head.next=head;
    size=0;
  //  size++;
...
//    l.insertBack( new Integer(6));
    System.out.println("l is a list of "+l.length()+ " elements: " + l);
    System.out.println("l.size= "+l.size+ " "+l.toString());

//    for(ListNode a=l.front(); a!=null; a=a.next()){
      ListNode a=l.front();
      System.out.println(a.item+" ");
  //  a=a.next();
    try {
      System.out.println(a.next().item + " "+a.next().next().item+ " "+a.next().next().next().item); //+ " "+a.next().next().next().next().item);
    ...
    System.out.println();
    System.out.println("***************");
    System.out.println(l.front()+" "+l.back());
    System.out.println(l.front().myList+" "+l.back().myList);

//    System.out.println(l.front().next.item+" "+l.back().prev.item);
//   System.out.println(l.head);
   System.out.println(((DList)l).head.next.item+" "+((DList)l).head.next.next.item);
//    System.out.println(l.head.item+l.head.next.item+l.head.next.next.item);
