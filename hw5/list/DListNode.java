...
//    size++;
    this.next=((DList)this.myList).newNode(item, (DList)this.myList, this, this.next);
    this.next.next.prev=this.next;
//    ((DList)this.myList).size++;
    (this.myList).size++;
...
//    size++;
    this.prev= ((DList)this.myList).newNode(item, (DList)this.myList, this.prev, this );
