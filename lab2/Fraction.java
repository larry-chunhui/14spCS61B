...
//    this.denominator = 1;
  ...
  public void changeNumerator(int numerator) { // DO NOT CHANGE THIS SIGNATURE!
    ...
    this.numerator = numerator; //chunhui liu
  }
  ...
  public int fracs() {                         // DO NOT CHANGE THIS SIGNATURE!
    // Fix the bug that prevents this method from working correctly.
	System.out.println("number of fractions= "+numberOfFractions);
	System.out.println("this.number of fractions= "+this.numberOfFractions);
    return this.numberOfFractions; //chunhui liu
  }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("Now f3 is " + f3 + ", which should be 7/20"); //correct
