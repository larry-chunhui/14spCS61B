...
class Date {
  ...
  days = (year - 1) * 365 + leapYearCount +dayInYear();
  return days;
  }
  ...
  public boolean isBefore(Date d) {
    return this.dayInAll() - d.dayInAll()  < 0;                     // replace this line with your solution
  }
  ...
  public static void main(String[] argv) {
	...
	System.out.println("1,10,2018 day in year should be: " + d0.dayInYear());
