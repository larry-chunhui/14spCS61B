...
//    head.next.next.prev = head.next;
    ...
    DListNode insertNode=newNode(null, null, null);
  ...
  public DListNode next(DListNode node) {
    if(node!=null && node!=back() && node.next!=head){
      return node.next;
    }
    else return null;
    // Your solution here.
 ...
 //   System.out.println("start convert to string");
    while (current != head) {
      result = result + current.item + "  ";
      current = current.next;
    }
//    System.out.println("end convert to string");
    return result + "]";
  }
  ...
  public int toSum(){
    ...
    for(DListNode cur=head.next; cur!=head; cur=cur.next){
      ...
      sum+=(int) cur.item;
 //     System.out.println((int) cur.item);
    }
    return sum;
...
//    int a=0;
//    int b=a;
////    String [] myName=new String "ChunhuiLiu";
////    String [] hisName=new String "ChunhuiLiu";
//   String myName="ChunhuiLiu";
//    String hisName= "ChunhuiLiu";
//    System.out.println("a=b? "+(a==b));
//    System.out.println("myName == hisName? "+(myName==hisName));
//    System.out.println("myName equals hisName? "+(myName.equals(hisName)));
    DListNode cur=head;
//    System.out.println("cur == head? "+(cur==head));
