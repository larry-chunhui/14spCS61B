...
public class TestDList {
    public static void main (String[] args) {
        ...
        System.out.println("Now we are testing DList insert back.");
        DList sl1 = new DList();
 //       System.out.println("Length of DList should == 0 "+(sl1.size==0) );
 //       System.out.println("item of DList should ==null."+(sl1.head.item==null) );


        sl1.insertBack(new Integer(6));
   //     System.out.println("Length of DList should ==1 ."+(sl1.size==1));
     //   System.out.println("Length of DList should =6 "+sl1.head.next.item);
        sl1.insertBack(new Integer(9));
        sl1.insertBack(new Integer(12));
       // System.out.println("Length of DList should ==1 ."+(sl1.size==3));
        // System.out.println("Length of DList should =12 "+sl1.head.next.next.next.item);
