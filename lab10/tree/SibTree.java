...
public class SibTree extends Tree {
  ...
  public static void main(String[] args) {
    ...
    try {
      r1 = r.child(1);
      System.out.println("r1.item()= "+r1.item()+" t.root().item= "+t.root().item);
    ...
    try {
        if(r.child(1)!= r1){
            System.out.println("Error: root node's first child is not r1");
        }
      if (r != r1.parent()) {
...
//succeed above
    ...
    r32 = null;
    try {
      r.insertChild(new Integer(13), 1000); //1000);
      ...
      if (r3.parent() != r) {
        ...
        if (r1.nextSibling() != r2) {
            System.out.println("  ERROR:  Second child of root does not think" +
                    " the root's first child is its next sibling.");
        }
...
//succeed above
      ...
      System.out.println("  ERROR: chunhui liu unexpected exception while adding and" +
                         " testing nodes.");
      //      System.exit(1);
    }
