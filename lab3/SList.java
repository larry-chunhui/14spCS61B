...
public class SList {
  ...
  public void insertEnd_tail(Object obj) {
    if (head == null) {
      head = new SListNode(obj);
      tail = head;
    } else {
  ...
  public static void main (String[] args) {
    ...
    list.insertFront(new Integer(9));
    list.insertFront(new Integer(6));
    System.out.println("Here is a list after insertFront 6, 9, 12: "
            + list.toString());

//    list.insertEnd(new Integer(15));
    list.insertEnd_tail(new Integer(15));

    list.insertFront(new Integer(3));
    System.out.println("Here is a list after insertFront 3, 6, 9, 12, 15: "
            + list.toString());
    System.out.println("head item= "+ list.head.item);
    System.out.println("tail item= "+ list.tail.item);
/*
    testEmpty();
